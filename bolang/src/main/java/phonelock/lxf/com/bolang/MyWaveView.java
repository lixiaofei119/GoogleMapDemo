...
//                Color.rgb(255, 189, 22), // 橙色
//                Color.rgb(221, 43, 6), // 红
//                Color.rgb(0, 25, 233), // 蓝色
//                Color.rgb(0, 232, 210)}, // 绿色
...
//        mPaint.setShader(linearGradient);
        LinearGradient lg = new LinearGradient(0, 0, 500, 500, Color.parseColor("#02a5fa"), Color.parseColor("#6c1fff"), Shader.TileMode.MIRROR); //参数一为渐变起初点坐标x位置，参数二为y轴位置，参数三和四分辨对应渐变终点，最后参数为平铺方式，这里设置为镜像
        mPaint.setShader(lg);
