...
//        mPaint.setColor(Color.RED);
        LinearGradient lg = new LinearGradient(0, 0, 500, 500, Color.parseColor("#9902a5fa"), Color.parseColor("#996c1fff"), Shader.TileMode.MIRROR); //参数一为渐变起初点坐标x位置，参数二为y轴位置，参数三和四分辨对应渐变终点，最后参数为平铺方式，这里设置为镜像
        mPaint.setShader(lg);
